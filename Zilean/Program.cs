...
namespace Zilean
{
    class Program
    {
        ...
        {
            Q = new Spell.Skillshot(SpellSlot.Q, 900, SkillShotType.Circular, 0.90f, 1850, 150);
        ...
        static void Combo1()
        {
            ...
            if (Q.IsReady() && predQ.HitChance >= HitChance.High && CanMove(target) && comboMenu["Combo.Q"].Cast<CheckBox>().CurrentValue && Player.Instance.Mana > QMANA + RMANA)
            {
