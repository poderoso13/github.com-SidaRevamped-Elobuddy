...
namespace Core
{
    public static class Orbwalking
    {
        ...
        {
            return AttackResets.Contains(name.ToLower(CultureInfo.CurrentCulture));
        }
        ...
        {
            return (name.ToLower(CultureInfo.CurrentCulture).Contains("attack") && !NoAttacks.Contains(name.ToLower(CultureInfo.CurrentCulture))) ||
                   Attacks.Contains(name.ToLower(CultureInfo.CurrentCulture));
        }
        ...
        private class BeforeAttackEventArgs : EventArgs
        {
